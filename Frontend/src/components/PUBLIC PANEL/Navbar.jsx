                    ...
                    <div className="bg-white w-full max-w-md h-full overflow-y-auto animate-slideIn">
                      ...
                      {cartLoading || localCartLoading ? (
                        ...
                        <div className="p-8 text-center">
                          ...
                          <Link to={"/plants"} onClick={toggleCartModal}>
                          <button 
                            onClick={toggleCartModal}
                            className="bg-yellow-500 hover:bg-yellow-600 text-green-950 font-medium py-2 px-4 rounded-md"
                          >
                            Continue Shopping
                          </button>
                          </Link>
                ...
                >
                  {userLoading ? (
                    ...
                    userDetails?.profilePic ? (
                      ...
                      <FaUserCircle className="text-yellow-500 text-3xl hover:text-yellow-400 transition-colors"
                      />
                    )
                  )}
                </button>
                ...
                {profileMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-50 divide-y divide-gray-100 animate-fadeIn">
                    ...
                    <div className="py-1">
                      <Link
                        to="/profile"
                        className={`flex items-center px-4 py-2 text-sm ${isActive('/profile') ? 'text-yellow-500' : 'text-gray-700'} hover:bg-gray-100`}
                      ...
                      <Link
                        to="/settings"
                        className={`flex items-center px-4 py-2 text-sm ${isActive('/settings') ? 'text-yellow-500' : 'text-gray-700'} hover:bg-gray-100`}
                        onClick={() => setProfileMenuOpen(false)}
                      >
                      ...
                      <Link
                        to="/wishlist"
                        className={`flex items-center px-4 py-2 text-sm ${isActive('/wishlist') ? 'text-yellow-500' : 'text-gray-700'} hover:bg-gray-100`}
                        onClick={() => setProfileMenuOpen(false)}
                      >
