              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    <label htmlFor="jazzcash" className="block text-green-200">
                      JazzCash
                    </label>
                    {formData.paymentMethod === 'jazzcash' && (
                      <div className="mt-2">
                        <label className="block text-green-200 text-sm mb-1">JazzCash Number</label>
                        <input
                          type="tel"
                          name="jazzcashNumber"
                          ...
                          className={`w-full px-4 py-2 rounded bg-green-900 border ${errors.jazzcashNumber ? 'border-red-500' : 'border-green-800'} text-white focus:outline-none focus:ring-2 focus:ring-yellow-500`}
                        />
                ...
                <div className="flex items-start">
                  ...
                  />
                  <div className="ml-3 flex-1">
                    <label htmlFor="easypaisa" className="block text-green-200">
                      EasyPaisa
                    </label>
                    {formData.paymentMethod === 'easypaisa' && (
                      <div className="mt-2">
                        <label className="block text-green-200 text-sm mb-1">EasyPaisa Number</label>
                        <input
                          type="tel"
                          ...
                          className={`w-full px-4 py-2 rounded bg-green-900 border ${errors.easypaisaNumber ? 'border-red-500' : 'border-green-800'} text-white focus:outline-none focus:ring-2 focus:ring-yellow-500`}
                        />
                        {errors.easypaisaNumber && <p className="text-red-500 text-sm mt-1">{errors.easypaisaNumber}</p>}
                      </div>
                    )}
                  </div>
                </div>
