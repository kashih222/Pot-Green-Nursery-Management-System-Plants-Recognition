      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            Get instant results with detailed information about your plant.
          </p>
        </div>
            ...
            {result && (
              <div className="space-y-6">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-green-800 mb-1">Plant Name</h4>
                  <p className="text-lg font-semibold text-green-900">{result.name}</p>
                </div>

                {/* Confidence Score */}
                {result.probabilities && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <h4 className="text-sm font-medium text-blue-800 mb-1">Confidence</h4>
                    <div className="flex items-center">
                      <div className="flex-1 bg-blue-200 rounded-full h-2 mr-3">
                        <div 
                          className="bg-blue-600 h-2 rounded-full transition-all duration-1000"
                          style={{ width: `${(result.probabilities[result.prediction] * 100).toFixed(1)}%` }}
                        ></div>
                      </div>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Receive instant identification with confidence scores and plant details</p>
            </div>
          </div>
        </div>
      </div>
