...
const Header = ({ onMenuClick }) => {
  ...
  const profilePic = currentUser?.profilePic || "src/assets/img/KashafProfile.jpeg";
      ...
      <header className="w-full h-12 border-b-2 border-yellow-500/30 bg-green-950 shadow-lg flex items-center">
        ...
        <div className="right-side w-full pr-8 flex items-center justify-end gap-2">
          ...
          <div className="relative">
            <div
              className="rounded-full w-8 h-8 overflow-hidden cursor-pointer border-2 border-yellow-500"
              onClick={handleClick}
          ...
          >
            <MenuItem onClick={handleClose} className="!bg-green-950 hover:!bg-green-900">
              <div className="flex items-center gap-3">
                <div className="rounded-full w-8 h-8 overflow-hidden border-2 border-yellow-500">
                  <img
                    src={profilePic}
                    alt={name}
                    className="object-cover w-full h-full"
            ...
            <MenuItem
              ...
              className="!text-gray-200 hover:!bg-green-900 !py-3"
            >
              <IoPersonAdd className="mr-2 text-yellow-500" />
              Add New Account
            </MenuItem>
            ...
            <MenuItem
              ...
              className="!text-gray-200 hover:!bg-green-900 !py-3"
            >
              <IoSettingsOutline className="mr-2 text-yellow-500" />
              Account Settings
            </MenuItem>
